...
class PostgresDBFactory extends AbstractResourceFactory<DatabaseConnection, DatabaseConfig> {
...
class MySQLFactory extends AbstractResourceFactory<DatabaseConnection, DatabaseConfig> {
...
class RedisFactory extends AbstractResourceFactory<CacheConnection, CacheConfig> {
...
class MemcachedFactory extends AbstractResourceFactory<CacheConnection, CacheConfig> {
...
class CustomFactory extends AbstractResourceFactory<string, { type: string; value: string }> {
  ...
  public async create(config?: { type: string; value: string }): Promise<string> {
...
describe('ResourceFactoryRegistry', () => {
  beforeEach(() => {
    ...
    // Register factories
    ResourceFactoryRegistry.registerFactory('DatabaseFactory', 'PostgresDB', PostgresDBFactory);
    ResourceFactoryRegistry.registerFactory('DatabaseFactory', 'MySQL', MySQLFactory);
    ResourceFactoryRegistry.registerFactory('CacheFactory', 'Redis', RedisFactory);
    ResourceFactoryRegistry.registerFactory('CacheFactory', 'Memcached', MemcachedFactory);
  });
  ...
  describe('createResource', () => {
    it('should create resource from valid configuration', async () => {
      ...
      const resource = await ResourceFactoryRegistry.createResource<DatabaseConnection>(
        'DatabaseFactory',
        config
      );
    ...
    it('should return null for null/undefined config', async () => {
      const resource1 = await ResourceFactoryRegistry.createResource('DatabaseFactory', null);
      const resource2 = await ResourceFactoryRegistry.createResource('DatabaseFactory', undefined);
    ...
    it('should throw error for config without type field', async () => {
      ...
      await expect(
        ResourceFactoryRegistry.createResource('DatabaseFactory', config)
    ...
    it('should handle validation errors', async () => {
      ...
      await expect(
        ResourceFactoryRegistry.createResource('DatabaseFactory', config, { validate: true })
    ...
    it('should skip validation when validate is false', async () => {
      ...
      const resource = await ResourceFactoryRegistry.createResource('DatabaseFactory', config, { validate: false });
    ...
    it('should pass factoryArgs to factory constructor and create method', async () => {
      ResourceFactoryRegistry.registerFactory('CustomFactory', 'Custom', CustomFactory);
      ...
      const resource = await ResourceFactoryRegistry.createResource<string>(
        'CustomFactory',
        config,
        { 
    ...
    it('should use custom validator when provided', async () => {
      ...
      expect(customValidator.validate).toHaveBeenCalledWith(config, expect.any(Object));
  ...
  describe('createDefaultResource', () => {
    it('should create resource using best default factory', async () => {
      ...
      const resource = await ResourceFactoryRegistry.createDefaultResource<DatabaseConnection>(
        'DatabaseFactory',
        config
      );
    ...
    it('should return null when no default factory exists', async () => {
      const resource = await ResourceFactoryRegistry.createDefaultResource(
        'NonExistentFactory',
        {}
      );
    ...
    it('should select factory with highest priority as default', async () => {
      ...
      const resource = await ResourceFactoryRegistry.createDefaultResource<CacheConnection>(
        'CacheFactory',
  ...
  describe('registerFactory', () => {
    it('should register factory with metadata', () => {
      ...
      const factory = ResourceFactoryRegistry.getFactory('TestFactory', 'TestType');
  ...
  describe('registerFactoryInstance', () => {
    it('should register factory instance directly', () => {
      ...
      ResourceFactoryRegistry.registerFactoryInstance('TestFactory', instance);

      const retrieved = ResourceFactoryRegistry.getFactory('TestFactory', 'PostgresDB');
  ...
  describe('getFactory', () => {
    it('should retrieve registered factory', () => {
      const factory = ResourceFactoryRegistry.getFactory<DatabaseConnection, DatabaseConfig>(
        'DatabaseFactory',
        'PostgresDB'
      );
    ...
    it('should pass arguments to factory constructor', () => {
      ...
      const factory = ResourceFactoryRegistry.getFactory('CustomFactory', 'Custom', 'test-prefix');
      expect(factory).toBeInstanceOf(CustomFactory);
    });

    it('should throw error for unknown factory type', () => {
      expect(() => {
        ResourceFactoryRegistry.getFactory('DatabaseFactory', 'UnknownDB');
  ...
  describe('getAvailableTypes', () => {
    it('should return all available factory types for base type', () => {
      const types = ResourceFactoryRegistry.getAvailableTypes('DatabaseFactory');
      expect(types).toEqual(expect.arrayContaining(['PostgresDB', 'MySQL']));
      expect(types).toHaveLength(2);
    });

    it('should return empty array for unknown base type', () => {
      const types = ResourceFactoryRegistry.getAvailableTypes('UnknownFactory');
  ...
  describe('getDefaultTypes', () => {
    it('should return all default factory types', () => {
      const defaults = ResourceFactoryRegistry.getDefaultTypes('DatabaseFactory');
    ...
    it('should return multiple defaults ordered by priority', () => {
      const defaults = ResourceFactoryRegistry.getDefaultTypes('CacheFactory');
  ...
  describe('clearCache', () => {
    it('should clear cache for specific base type and resource type', () => {
      ...
      const factory1 = ResourceFactoryRegistry.getFactory('DatabaseFactory', 'PostgresDB');
      
      // Clear specific cache
      ResourceFactoryRegistry.clearCache('DatabaseFactory', 'PostgresDB');
      
      // Get factory again - should be different instance
      const factory2 = ResourceFactoryRegistry.getFactory('DatabaseFactory', 'PostgresDB');
      expect(factory1).not.toBe(factory2);
    });

    it('should clear all caches for base type when resource type not specified', () => {
      // Get factories to populate cache
      const dbFactory1 = ResourceFactoryRegistry.getFactory('DatabaseFactory', 'PostgresDB');
      const mysqlFactory1 = ResourceFactoryRegistry.getFactory('DatabaseFactory', 'MySQL');
      ...
      const dbFactory2 = ResourceFactoryRegistry.getFactory('DatabaseFactory', 'PostgresDB');
      const mysqlFactory2 = ResourceFactoryRegistry.getFactory('DatabaseFactory', 'MySQL');
    ...
    it('should clear all caches when no parameters specified', () => {
      ...
      const dbFactory1 = ResourceFactoryRegistry.getFactory('DatabaseFactory', 'PostgresDB');
      const cacheFactory1 = ResourceFactoryRegistry.getFactory('CacheFactory', 'Redis');
      ...
      // Get factories again - should be different instances
      const dbFactory2 = ResourceFactoryRegistry.getFactory('DatabaseFactory', 'PostgresDB');
      const cacheFactory2 = ResourceFactoryRegistry.getFactory('CacheFactory', 'Redis');
  ...
  describe('convenience functions', () => {
    it('should work with createResource function', async () => {
      ...
      const resource = await createResource<DatabaseConnection>('DatabaseFactory', config);
      expect(resource).toBeDefined();
      expect(resource!.connected).toBe(true);
    });
    ...
    it('should work with getFactory function', () => {
      const factory = getFactory<DatabaseConnection, DatabaseConfig>('DatabaseFactory', 'PostgresDB');
      expect(factory.type).toBe('PostgresDB');
    });
  });
  ...
  describe('error handling', () => {
    it('should handle factory creation errors gracefully', async () => {
      ...
      ResourceFactoryRegistry.registerFactory('TestFactory', 'Failing', FailingFactory);

      await expect(
        ResourceFactoryRegistry.createResource('TestFactory', { type: 'Failing' })
