...
class BasicTestFactory extends AbstractResourceFactory<
    TestResource,
    TestConfig
> {
...
class DefaultTestFactory extends AbstractResourceFactory<
    TestResource,
    TestConfig
> {
...
class HighPriorityFactory extends AbstractResourceFactory<
    SimpleResource,
    SimpleConfig
> {
...
class ConfigurableFactory extends AbstractResourceFactory<
    TestResource,
    TestConfig
> {
...
class AsyncComplexFactory extends AbstractResourceFactory<
    TestResource,
    TestConfig
> {
...
describe('ResourceFactory Interface', () => {
    describe('AbstractResourceFactory', () => {
        ...
        it('should handle null configuration', async () => {
            ...
            await expect(factory.create(null as any)).rejects.toThrow(
                'Configuration is required'
            );
        });
    ...
    describe('Factory Constructor Type', () => {
        it('should properly type factory constructors', () => {
            const constructors: FactoryConstructor<TestResource, TestConfig>[] =
                [BasicTestFactory, DefaultTestFactory, AsyncComplexFactory];
            ...
            const instances = constructors.map(
        ...
        it('should support parameterized constructors', () => {
            ...
            const instance2 = new ParameterizedConstructor(
                true,
                99,
                'test-data'
            );
    ...
    describe('FactoryInfo Structure', () => {
        it('should properly structure factory information', () => {
            ...
            expect(factoryInfo.metadata?.description).toBe(
    ...
    describe('Priority and Default Behavior', () => {
        ...
        it('should sort factories by priority', () => {
            ...
            const sortedByPriority = factories.sort(
    ...
    describe('Error Handling and Edge Cases', () => {
        it('should handle factories that return null', async () => {
            class NullFactory extends AbstractResourceFactory<
                TestResource | null,
                TestConfig
            > {
        ...
        it('should handle factories with complex generic types', async () => {
            ...
            class GenericFactory<T> extends AbstractResourceFactory<
                ComplexResource<T>,
                { type: string; value: T }
            > {
            ...
            const stringResult = await stringFactory.create({
                type: 'string',
                value: 'test',
            });
            const numberResult = await numberFactory.create({
                type: 'number',
                value: 42,
            });
